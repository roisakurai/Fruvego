package com.paniroisapplication.app.modules.registerone.`data`.model
...
data class RegisterOneModel(
   ...
   * TODO Replace with dynamic value
   */
  var txtLanguage: String? = MyApp.getInstance().resources.getString(R.string.msg_sudah_punya_aku)
  ,
  /**
   * TODO Replace with dynamic value
   */
