...
class SpinnerGroup36813ThreeAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroup36813ThreeModel>
) : ArrayAdapter<SpinnerGroup36813ThreeModel>(mContext, layoutResource, allItems) {
