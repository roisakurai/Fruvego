...
class SpinnerGroup36813OneAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroup36813OneModel>
) : ArrayAdapter<SpinnerGroup36813OneModel>(mContext, layoutResource, allItems) {
