...
class SpinnerGroup36813FourAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroup36813FourModel>
) : ArrayAdapter<SpinnerGroup36813FourModel>(mContext, layoutResource, allItems) {
